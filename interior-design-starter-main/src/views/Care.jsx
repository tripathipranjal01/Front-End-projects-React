...
const Care = () => {
  return <div id="care" className="px-10 max-w-[1490px] mx-auto mt-[100px] mb-[160px]">
...
<div>
  ...
  <h6 className="text-left xs:text.start text-base lg:text-lg text-fontGray font-medium">
    {item.subtitle}
  </h6>
</div>
</div>
